...
CREATE TABLE `class` (
  ...
  `Class_name` enum('General','Sleeper','3AC','2AC','1AC') DEFAULT NULL,
  `Fare_multiplier` decimal(5,2) DEFAULT NULL,
...
INSERT INTO `class` VALUES (1,'General',100.00),(2,'Sleeper',150.75),(3,'3AC',250.05),(4,'2AC',350.02),(5,'1AC',500.09);
